...
/*
 * Time Complexity: O(n)
 * Space Complexity: O(1) because the size of the maps is at most 26 (for lowercase 
 * English letters)
 */
...
int main() {
    ...
    std::cout << "racecar, carrace: " << validAnagram.isAnagram("racecar", "carrace") << std::endl;
    std::cout << "jar, jam: " << validAnagram.isAnagram("jar", "jam") << std::endl;
    return 0;
}
